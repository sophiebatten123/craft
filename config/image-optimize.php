...
return [
    ...
    'imageProcessors' => [
        // jpeg optimizers
        'jpegoptim' => [
            'commandPath' => '/opt/homebrew/bin/jpegoptim',
            'commandOptions' => '-s',
        ...
        // png optimizers
        'optipng' => [
            'commandPath' => '/opt/homebrew/bin/optipng',
        ...
        // svg optimizers
        'svgo' => [
            'commandPath' => '/Users/sophiebatten/.nvm/versions/node/v8.0.0/bin/svgo',
            'commandOptions' => '',
            'commandOutputFileFlag' => '',
        ],
        // gif optimizers
        'gifsicle' => [
            'commandPath' => '/opt/homebrew/bin/gifsicle',
    ...
    'imageVariantCreators' => [
        ...
        'cwebp' => [
            'commandPath' => '/opt/homebrew/bin/cwebp',
            'commandOptions' => '',
